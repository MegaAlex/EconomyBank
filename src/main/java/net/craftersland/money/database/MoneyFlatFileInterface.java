...
public class MoneyFlatFileInterface implements AccountDatabaseInterface<Double> {
	...
	public boolean hasAccount(Player player) {
		return (new File("plugins" + System.getProperty("file.separator") + "MysqlEconomyBank"
				+ System.getProperty("file.separator") + "Accounts" + System.getProperty("file.separator")
				+ player.getUniqueId().toString() + ".yml")).exists();
	}
	...
	public boolean hasAccount(UUID playerUUID) {
		return (new File("plugins" + System.getProperty("file.separator") + "MysqlEconomyBank"
				+ System.getProperty("file.separator") + "Accounts" + System.getProperty("file.separator")
				+ playerUUID.toString() + ".yml")).exists();
	}

	@Override
	public boolean createAccount(Player player) {
		try {
			File accountFile = new File("plugins" + System.getProperty("file.separator") + "MysqlEconomyBank"
					+ System.getProperty("file.separator") + "Accounts" + System.getProperty("file.separator")
